...
public class NodeMaintenanceActions {
  public static class EnableNodeMaintenanceAction extends NodeAction {
    ...
    public String getName() {
      return "EnableMaintenanceMode - Node " + getAttribute(OrionConstants.NODE_ID).getValue().toString();
    }
  ...
  public static class DisableNodeMaintenanceAction extends NodeAction {
    ...
    @Override
    public String getName() {
      return "DisableMaintenanceMode - Node" + getAttribute(OrionConstants.NODE_ID).getValue().toString();
    }
