...
public class PDResolveIncidentAction extends PDBaseAction {

  @Override
  public void runAction() throws Exception {
    PagerDutyClient pd = getPagerDutyClient();

    if (!containsAttribute(PDBaseAction.ATTR_PD_INCIDENT_ID_KEY)) {
      markFailed("No incidents in attributes");
      return;
    }
    String incidentId = getAttribute(PDBaseAction.ATTR_PD_INCIDENT_ID_KEY).getValue();
    String notes = null;
    ...
    pd.resolveIncident(incidentId, notes);
