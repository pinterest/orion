        ...
        try {
          ...
          OrionServer.metricsCounterInc(
                  ...
                  new HashMap<String, String>() {{
                    ...
                    put("confRoute53ZoneId", confRoute53ZoneId);
                    put("confRoute53Name", confRoute53Name);
                  }}
          );
          markFailed(e);
          return;
    ...
    return new AttributeSchema()
        .addValue(
            new TextEnumValue(ATTR_INSTANCE_TYPE_KEY, "Instance Type (optional, will inherit current type if not selected)", false)
                    ...
                    .addOption("c6id.xlarge", "c6id.xlarge")
                    .addOption("c6id.2xlarge", "c6id.2xlarge")
                    .addOption("c6id.4xlarge", "c6id.4xlarge")
                    .addOption("c6id.8xlarge", "c6id.8xlarge")
                    .addOption("c6id.12xlarge", "c6id.12xlarge")
                    .addOption("r6id.xlarge", "r6id.xlarge")
                    .addOption("r6id.2xlarge", "r6id.2xlarge")
                    .addOption("r6id.4xlarge", "r6id.4xlarge")
                    .addOption("r6id.8xlarge", "r6id.8xlarge")
                    .addOption("m6id.xlarge", "m6id.xlarge")
                    .addOption("m6id.2xlarge", "m6id.2xlarge")
