...
public abstract class HBaseSensor extends Sensor {
  ...
  public void observe(Cluster cluster) throws Exception {
    ...
    if(cluster instanceof HBaseCluster){
      sense((HBaseCluster) cluster);
    }
  }
  
  public abstract void sense(HBaseCluster cluster) throws Exception;
