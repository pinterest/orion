...
public class KafkaStuckConsumerGroupRecoveryAction extends Action {
  ...
  public void runAction() throws Exception {
    ...
    getEngine().alert(AlertLevel.MEDIUM,
        new AlertMessage(
    ...
    try {
      ...
      if (!stuckGroupIds.isEmpty()) {
        ...
        getEngine().alert(
            AlertLevel.MEDIUM, new AlertMessage("Failed to stablize the " + clusterId + " consumer group(s) " + stuckGroupIds + " after " + stableTimeoutSeconds + " seconds",
